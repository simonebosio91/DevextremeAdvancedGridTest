...
export class AppComponent implements OnInit {
    ...
    // datasource: any = null;
    // advMasterDetail_subgridLoaded: any[] = null;
    ...
    //     let filterColumn = this.strutturaGriglia.Columns.filter(x=>x.Name == column.name);
    ...
    //
    //     let parentStruct = this.strutturaGriglia;
